...
namespace BatalhaNaval
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Direitos reservados JOANA COELHO | 2022 - v1");
            Console.WriteLine("Bem-vindo ao jogo de Batalha Naval!");
            Console.WriteLine("Regras:");
            Console.WriteLine("1. Dois jogadores e cada um tabuleiro de 10x10 com navios escondidos.");
            Console.WriteLine("2. Cada jogador escolhe um ponto no tabuleiro para atirar e tem 3 tentativas para acertar!");
            Console.WriteLine("3. O objetivo é destruir todos os navios do adversário antes que ele destrua os seus.");
            Console.WriteLine("4. O jogo termina quando todos os navios de um dos jogadores forem destruídos.");
            Console.WriteLine();
            Console.WriteLine("Legenda:");
            Console.WriteLine("- Oceano vazio:  '-'");
            Console.WriteLine("- Navio escondido: 'D'");
            Console.WriteLine("- Navio não atingido:  'O'");
            Console.WriteLine("- Navio atingido:  'X'");
            Console.WriteLine();     
            Console.WriteLine("Após ouvir a introdução, pressione qualquer tecla para continuar! Boa sorte! \n");            
            ...
            do
            {
                for (int i = 0; i < submarinos2.Length; i++) //até ao comprimento do array submarinos2 - são 8
                {
                    ...
                    //Caso não esteja ocupada sai e mete mete o D na posição inserida pelo utilizador
                    tabuleiro1[x, y] = " D ";
